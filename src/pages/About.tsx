...
const milestones = [
  ...
  { value: 95, suffix: "%", label: "Job Placement Rate", icon: Briefcase },
...
const achievements = [
  "Best Tech Training Center - Lagos Tech Awards 2023",
  "Top 10 EdTech Startups in Nigeria - TechCabal",
  "Google Developer Community Partner",
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 gap-4">
            {milestones.map((milestone) => (
              <Card key={milestone.label} className="border-border/50">
